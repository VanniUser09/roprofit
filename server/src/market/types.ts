...
export type Limited = {
  ...
  lastSeenAt: TemporalValue | null
  resellersCheckedAt: TemporalValue | null
  dailyCheckedAt: TemporalValue | null
  sources: { roblox: boolean; rolimons: boolean }
}

export type Tier = "A" | "B"

/** Data em trânsito: Date vindo do Postgres, ISO na API. */
export type TemporalValue = Date | { toDate(): Date } | string
